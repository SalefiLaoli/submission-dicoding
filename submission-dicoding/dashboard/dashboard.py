...
main_df = day[(day['dateday'] >= str(start_date)) & 
...
ax3.plot(daily_rent_df['dateday'], daily_rent_df['count'])
ax3.set_title('Total Rentals')
st.pyplot(fig3)
...
# Menggambar bar plot untuk jumlah penyewaan berdasarkan kondisi cuaca
sns.barplot(
    x=weather_rent_df.index,
    y='count',
    data=weather_rent_df,
    palette='viridis',  # Menggunakan palette warna 'viridis'
    ax=ax
)

# Menambahkan teks untuk menampilkan jumlah penyewaan pada setiap bar
for index, row in enumerate(weather_rent_df['count']):
    ax.text(index, row + 1, str(row), ha='center', va='bottom', fontsize=12)

# Mengatur label sumbu x dan y serta ukuran label
...
# Membuat jumlah penyewaan berdasarkan temp, atemp dan humadity
